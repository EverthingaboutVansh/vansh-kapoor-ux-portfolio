...
export default function AboutSection() {
  return <section id="about" className="py-20 bg-graybg dark:bg-primary transition-colors">
      <div className="container mx-auto flex flex-col md:flex-row gap-14 items-center">
        <div className="w-44 h-44 rounded-full border-4 border-primary overflow-hidden bg-white dark:bg-background flex-shrink-0 shadow-md">
          <img alt="Profile" className="object-cover w-full h-full" src="https://i.postimg.cc/1tKWKdyF/Portfolio-image.jpg" />
        </div>
        <div className="flex-1">
          <h2 className="font-poppins text-3xl font-bold text-primary dark:text-accent mb-2">About Me</h2>
          ...
          <p className="mb-6 text-base max-w-2xl text-primary dark:text-white/90">
          ...
          <div>
            <h4 className="font-semibold text-lg text-primary dark:text-accent mb-1">Education</h4>
